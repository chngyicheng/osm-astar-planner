...
RoutePlanner::RoutePlanner(RouteModel &model, float start_x, float start_y, float end_x, float end_y): m_Model(model) {
    ...
    RouteModel::Node *node_start = &(m_Model.FindClosestNode(start_x, start_y));
    RouteModel::Node *node_end   = &(m_Model.FindClosestNode(end_x, end_y));
    this->start_node = node_start;
    this->end_node   = node_end;
}
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    path_found.insert(path_found.begin(), *curr);
